...
export default async function ParentAttendancePage() {
  ...
  return (
    <div className="flex flex-col gap-8">
      {/* Header */}
      <div>
        <h1 className="font-tagline text-2xl font-semibold text-ink">Theo dÃµi chuyÃªn cáº§n cá»§a con</h1>
        <p className="font-caption text-ink-muted-80 mt-1">
          Lá»‹ch sá»­ chuyÃªn cáº§n chi tiáº¿t cá»§a há»c sinh: <span className="font-semibold text-ink">{childName}</span>
        </p>
      </div>
      ...
      <div className="grid grid-cols-4 gap-4">
        <div className="bg-canvas border border-hairline rounded-lg p-5 shadow-sm">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[11px] font-caption-strong text-ink-muted-48 uppercase font-bold">CÃ³ máº·t</span>
          </div>
        ...
        <div className="bg-canvas border border-hairline rounded-lg p-5 shadow-sm">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[11px] font-caption-strong text-ink-muted-48 uppercase font-bold">Váº¯ng máº·t</span>
          </div>
        ...
        <div className="bg-canvas border border-hairline rounded-lg p-5 shadow-sm">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[11px] font-caption-strong text-ink-muted-48 uppercase font-bold">Äi trá»…/PhÃ©p</span>
          </div>
        ...
        <div className="bg-canvas border border-hairline rounded-lg p-5 shadow-sm">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[11px] font-caption-strong text-ink-muted-48 uppercase font-bold">Tá»‰ lá»‡ Ä‘i há»c</span>
          </div>
      ...
      <div className="bg-canvas border border-hairline rounded-lg shadow-sm overflow-hidden">
        <div className="px-6 py-4 border-b border-hairline bg-surface-pearl">
          <h2 className="font-body-strong text-sm text-ink">Báº£n ghi Ä‘iá»ƒm danh gáº§n Ä‘Ã¢y cá»§a con</h2>
        </div>
        {attendances.length === 0 ? (
          <div className="p-16 text-center">
            <CheckSquare className="h-12 w-12 text-ink-muted-48 mx-auto mb-4" />
            <p className="font-body text-ink-muted-80">ChÆ°a ghi nháº­n Ä‘iá»ƒm danh.</p>
          </div>
        ) : (
          <table className="w-full">
            <thead>
              <tr className="border-b border-hairline">
                ...
                <th className="text-left px-6 py-3 text-[11px] font-caption-strong text-ink-muted-48 uppercase tracking-wider">Nháº­n xÃ©t tá»« giÃ¡o viÃªn</th>
              </tr>
            </thead>
            <tbody>
              {attendances.map((a) => (

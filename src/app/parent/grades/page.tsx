  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div>
          <h1 className="font-tagline text-2xl font-semibold text-ink">Báo cáo điểm thi thử của con</h1>
          <p className="font-caption text-ink-muted-80 mt-1">
            Bảng điểm thi thử và luyện đề chi tiết của học viên: <strong className="text-ink">{childName}</strong>
          </p>
        </div>
                ...
                <tbody>
                  {subject.grades.map((g, i) => (
                    <tr key={i} className="border-b border-hairline last:border-0 hover:bg-surface-pearl transition-colors">
                      ...
                      <td className="px-6 py-3.5 text-xs text-ink-muted-80 font-caption">{g.remarks || "Làm bài tốt, lưu ý các lỗi lý thuyết cơ bản."}</td>
                    </tr>
                  ))}
                </tbody>
              </table>

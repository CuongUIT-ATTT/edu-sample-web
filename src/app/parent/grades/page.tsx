  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="font-tagline text-2xl font-semibold text-ink">Báo cáo điểm số của con</h1>
          <p className="font-caption text-ink-muted-80 mt-1">
            Bảng điểm chi tiết môn học của học sinh: <span className="font-semibold text-ink">{childName}</span>
          </p>
        </div>
        <div className="flex items-center gap-3 bg-canvas border border-hairline rounded-lg px-5 py-3 shadow-sm">
          <Award className="h-6 w-6 text-purple-600" />
          <div>
            <p className="text-[10px] font-caption text-ink-muted-48 uppercase tracking-wider">Điểm trung bình (GPA)</p>
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="bg-canvas border border-hairline rounded-lg p-5 shadow-sm">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="font-caption-strong text-xs text-ink-muted-80">Bài kiểm tra đã làm</span>
          </div>
      ...
      {gradesBySubject.length === 0 ? (
        <div className="bg-canvas border border-hairline rounded-lg p-16 text-center shadow-sm">
          ...
          <p className="font-body text-ink-muted-80">Chưa có kết quả học tập được ghi nhận cho con của bạn.</p>
        </div>
      ) : (
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-hairline">
                    ...
                    <th className="text-left px-6 py-3 text-[11px] font-caption-strong text-ink-muted-48 uppercase tracking-wider">Ngày chấm</th>

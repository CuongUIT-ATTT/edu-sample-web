    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div className="lg:col-span-2 flex flex-col gap-6">
        <div>
          ...
          <p className="font-caption text-ink-muted-80 mt-1">Danh mục lớp luyện thi và giảng viên phụ trách tương ứng</p>
        </div>
        ...
        <div className="bg-canvas border border-hairline rounded-lg shadow-sm overflow-hidden">
          <div className="px-6 py-4 border-b border-hairline bg-surface-pearl flex items-center justify-between">
            <h2 className="font-body-strong text-sm text-ink flex items-center gap-2">
              ...
              Tổng cộng ({classesList.length} lớp luyện thi)
            </h2>
          </div>
          <table className="w-full">
            <thead>
              <tr className="border-b border-hairline bg-surface-pearl">
                ...
                <th className="text-center px-6 py-3 text-[11px] font-caption-strong text-ink-muted-48 uppercase tracking-wider">Khối học</th>
                <th className="text-center px-6 py-3 text-[11px] font-caption-strong text-ink-muted-48 uppercase tracking-wider">Sĩ số</th>
                <th className="text-left px-6 py-3 text-[11px] font-caption-strong text-ink-muted-48 uppercase tracking-wider">Giảng viên phụ trách</th>
              </tr>
            </thead>
            <tbody>
              {classesList.map((c) => (

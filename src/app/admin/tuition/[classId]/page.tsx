...
import ClassTuitionDetail from "./ClassTuitionDetail";
  ...
  return (
    <div className="flex flex-col gap-6 max-w-5xl">
      <div className="flex items-center gap-3">
        <Link href="/admin/tuition" className="h-8 w-8 rounded-lg border border-hairline flex items-center justify-center hover:bg-surface-pearl transition-colors">

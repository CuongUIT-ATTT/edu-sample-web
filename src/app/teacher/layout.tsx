      ...
      >
        <div className="flex flex-col gap-8">
          ...
          >
            ...
            <span className="text-[8px] md:text-[10px] bg-green-100 text-green-700 px-1.5 md:px-2 py-0.5 rounded-full font-bold uppercase text-center ml-auto">
              GV
            </span>
          </Link>

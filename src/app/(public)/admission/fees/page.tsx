...
export default function FeesPage() {
  const packages = [
    ...
    },
    {
      ...
      price: "15,000,000đ",
      period: "khóa 1 năm",
      target: "Đào tạo đặc biệt kèm 1-1, cam kết tuyệt đối đỗ các trường đại học top 1 (Y Dược, Bách Khoa, FTU).",
      features: [
        "Học không giới hạn tất cả các ca trong tuần",
        "Lịch trình ôn tập riêng thiết kế cá nhân hóa",
        "Giải đáp riêng trực tiếp 1-1 cùng Thầy Hùng Cường",
        "Hoàn trả 100% học phí nếu không đạt điểm mục tiêu cam kết",
        "Ưu tiên gửi đơn tuyển sinh và giữ chỗ lớp offline VIP",
      ],
      popular: false,
    },
  ];

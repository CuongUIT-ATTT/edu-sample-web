...
export default async function StudentAttendancePage() {
  ...
  return (
    <div className="flex flex-col gap-8">
      {/* Header */}
      <div>
        <h1 className="font-tagline text-2xl font-semibold text-ink">Chuyên cần</h1>
        <p className="font-caption text-ink-muted-80 mt-1">Lịch sử điểm danh — {studentName}</p>
      </div>
      ...
      <div className="grid grid-cols-4 gap-4">
        <div className="bg-canvas border border-hairline rounded-lg p-5 shadow-sm">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[11px] font-caption-strong text-ink-muted-48 uppercase">Có mặt</span>
          </div>
        ...
        <div className="bg-canvas border border-hairline rounded-lg p-5 shadow-sm">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[11px] font-caption-strong text-ink-muted-48 uppercase">Vắng mặt</span>
          </div>
        ...
        <div className="bg-canvas border border-hairline rounded-lg p-5 shadow-sm">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[11px] font-caption-strong text-ink-muted-48 uppercase">Đi trễ</span>
          </div>
        ...
        <div className="bg-canvas border border-hairline rounded-lg p-5 shadow-sm">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[11px] font-caption-strong text-ink-muted-48 uppercase">Tỉ lệ chuyên cần</span>
          </div>
      ...
      <div className="bg-canvas border border-hairline rounded-lg shadow-sm overflow-hidden">
        <div className="px-6 py-4 border-b border-hairline bg-surface-pearl">
          <h2 className="font-body-strong text-sm text-ink">Lịch sử điểm danh ({total} bản ghi)</h2>
        </div>
        {attendances.length === 0 ? (
          <div className="p-16 text-center">
            <CheckSquare className="h-12 w-12 text-ink-muted-48 mx-auto mb-4" />
            <p className="font-body text-ink-muted-80">Chưa có dữ liệu điểm danh.</p>
          </div>
        ) : (

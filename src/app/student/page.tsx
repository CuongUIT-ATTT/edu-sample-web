        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h4 className="font-tagline text-sm font-bold">
              Kỳ thi Tốt nghiệp THPT Quốc Gia 2027
            </h4>
            <p className="text-[11px] text-indigo-200">
              Đặc trị các lỗi sai lý thuyết và bứt phá điểm số cùng Thầy Hùng
              Cường
            </p>
          </div>
        </div>
            ...
            >
              ...
              <span
                className={`text-xs px-2.5 py-0.5 rounded-full font-semibold ${
                  item.status.includes("Có mặt") ||
                  item.status.includes("điểm danh")

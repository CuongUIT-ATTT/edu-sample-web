  ...
  return (
    <div className="flex flex-col gap-8 max-w-[1200px]">
      ...
      <div>
        ...
        <p className="font-caption text-ink-muted-80 mt-1">Lớp {className} • Học sinh trường. Chúc bạn một ngày học tập hiệu quả!</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-canvas border border-hairline rounded-lg p-6 flex flex-col gap-3">
          ...
          <div>
            ...
            <h3 className="font-display-lg text-2xl font-bold text-ink mt-1">{displaySubjectsCount} Môn</h3>
          </div>
        </div>
      </div>

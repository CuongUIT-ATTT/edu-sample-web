      ...
      <aside className="hidden md:flex md:w-64 bg-canvas border-r border-hairline flex-col justify-between p-3 md:p-6 flex-shrink-0 transition-all duration-300">
        <div className="flex flex-col gap-8">
          ...
          >
            ...
            <span className="text-[8px] md:text-[10px] bg-blue-100 text-blue-700 px-1 md:px-2 py-0.5 rounded-full font-bold uppercase text-center">
              HV
            </span>
          </Link>
          ...
          <nav className="flex flex-col gap-2">
            ...
            >
              ...
              <span className="hidden md:inline">Lịch học tuần</span>
            </Link>
            <Link
            ...
            >
              ...
              <span className="hidden md:inline">Chuyên cần</span>
            </Link>
            <Link
              href="/student/grades"
              onClick={closeSidebar}
          ...
          <aside className="relative z-10 flex h-full w-72 max-w-[85vw] flex-col justify-between bg-canvas border-r border-hairline p-4 shadow-2xl">
            <div className="flex flex-col gap-8">
              ...
              >
                ...
                <span className="text-[8px] bg-blue-100 text-blue-700 px-1.5 py-0.5 rounded-full font-bold uppercase text-center">
                  HV
                </span>
              </Link>

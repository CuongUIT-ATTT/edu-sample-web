      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div>
          <h1 className="font-tagline text-2xl font-semibold text-ink">
            Bảng điểm thi thử & Luyện đề
          </h1>
          <p className="font-caption text-ink-muted-80 mt-1">
            Báo cáo điểm số các chiến dịch thi trực tuyến của học viên:{" "}
            <strong className="text-ink">{studentName}</strong>
          </p>
        </div>
      ...
      {gradesBySubject.length === 0 ? (
        <div className="bg-canvas border border-hairline rounded-lg p-16 text-center shadow-sm">
          ...
          <p className="font-body text-ink-muted-80">
            Chưa có kết quả bài thi thử nào.
          </p>
          <p className="font-caption text-ink-muted-48 text-sm mt-1">
            Hệ thống sẽ cập nhật điểm ngay sau khi bạn hoàn thành bài trắc
            nghiệm.
          </p>
        </div>
      ) : (
                  ...
                  {subject.grades.map((g, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-6 py-3.5 text-xs text-ink-muted-80 font-caption">
                          {g.remarks ||
                            "Bài làm tốt, lưu ý các lỗi sai lý thuyết căn bản."}
                        </td>
                      </tr>
                    );
                  })}
